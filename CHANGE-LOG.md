...
|---|---|---|---|
| 2026-09-25 | BUILD executor | FOUNDER-PULL QA absorb — C1 Continue confirmed; Majors 2–34 + Minors 5–6 closed. | C1 `data-to-practice` enable + mark-before-gate verified (no revert); M1 exemplar coach-plain; M3 deep-set → three taught patterns; EO chrome → Objective N hub+M1–M7; Exemplar labels → coach titles; optional empty-Practice warn once. HARD-GATE/pedagogy/keys unchanged. |
